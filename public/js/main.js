...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (getCookie("ct-username") && document.querySelector("#sidemenu")) {
        let div0 = create("DIV");
    ...
    if(getCookie("ct-username")){
        document.querySelector("header nav").innerHTML = `<ul class="rows">
              <li class="active"><a href="/dashboard" class="strip-link">Account Dashboard</a></li>
              <li><a href="/support#faq" class="strip-link">FAQs</a></li>
              <li><a href="#" class="strip-link">Privacy Policy</a></li>
              <li><a href="#" class="strip-link">Terms and Conditions</a></li>
              <li><a href="/support" class="strip-link">Contact Us</a></li>
              <li><a href="/logout" class="strip-link">Logout</a></li>
          </ul>`;
    }else{
